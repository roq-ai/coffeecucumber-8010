...
function BlogPostViewPage() {
  ...
  const { data, error, isLoading, mutate } = useSWR<BlogPostInterface>(
    ...
    () =>
      getBlogPostById(id, {
        relations: ['user', 'organization', 'image', 'upvote'],
      }),
  );
              ...
              {hasAccess('image', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                <Stack spacing={2} mb={8}>
                  <Flex justifyContent="space-between">
                    ...
                    <NextLink passHref href={`/images/create?blog_post_id=${data?.id}`}>
              ...
              {hasAccess('upvote', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                <Stack spacing={2} mb={8}>
                  <Flex justifyContent="space-between">
                    ...
                    <NextLink passHref href={`/upvotes/create?blog_post_id=${data?.id}`}>
                      <Button colorScheme="blue" mr="4" as="a">
                        Create
                      </Button>
                    </NextLink>
